...
@interface ViewController ()<LDXMoveTableViewDataSource, LDXMoveTableViewDelegate>
...
- (void)viewDidLoad {
    ...
    LDXMoveTableView *tableView = [[LDXMoveTableView alloc] initWithFrame:self.view.bounds style:UITableViewStyleGrouped];
